...
- Count was exact (128000) at every K -> the no-shard-missing-bucket design is safe ONLY because every doc was stamped first (see [[Fan-out count is only faster if the shard field is the index trailing key]]).
